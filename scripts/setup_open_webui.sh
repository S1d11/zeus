...
# Bootstrap Open WebUI against Zeus's OpenAI-compatible API server.
#
...
HERMES_API_MODEL_NAME="${HERMES_API_MODEL_NAME:-Zeus}"
...
install_systemd_user_service() {
  ...
  cat > "$unit" <<EOF
[Unit]
Description=Open WebUI connected to Zeus
