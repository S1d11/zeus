...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Hermes"                  # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Hermes"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Hermes",
            "welcome": "Welcome to Hermes! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
