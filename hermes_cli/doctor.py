...
Diagnoses issues with Zeus setup.
"""
...
def run_doctor(args):
    ...
    if soul_path.exists():
        ...
        check_warn(f"{_DHH}/SOUL.md not found", "(create it to give Zeus a custom personality)")
        if should_fix:
            soul_path.parent.mkdir(parents=True, exist_ok=True)
            soul_path.write_text(
                "# Zeus Persona\n\n"
                "<!-- Edit this file to customize how Zeus communicates. -->\n\n"
