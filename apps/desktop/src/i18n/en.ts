...
export const en: Translations = {
  ...
  boot: {
    ready: 'Zeus Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Zeus settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Zeus Desktop…'
    },
    errors: {
      backgroundExited: 'Zeus background process exited.',
      backgroundExitedDuringStartup: 'Zeus background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Zeus backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Zeus',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Zeus Desktop.',
    ...
    native: {
      ...
      inputBody: 'Zeus is waiting for your response.',
      turnDoneTitle: 'Zeus finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Zeus defaults?',
    ...
    appearance: {
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Zeus is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Zeus, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Zeus checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Zeus configuration...',
    ...
    gateway: {
      ...
      intro:
        'Zeus Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Zeus backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset Zeus_DESKTOP_REMOTE_URL and Zeus_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Zeus backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Zeus backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /Zeus.',
      ...
      restartingMessage: 'Zeus Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Zeus ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Zeus runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Zeus to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Zeus to generate pets.',
      backgroundHint: 'You can close this — Zeus will notify you when it’s done.',
    ...
    hermesActiveSessions: (version, count) => `Zeus ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@Zeus:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Zeus environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Zeus will run it and deliver results to the destination you pick.',
  ...
  connections: {
    ...
    oauthDisconnect: 'Disconnect (clear tokens)',
    ...
    oauthLogoutSuccess: 'OAuth tokens cleared',
    oauthLogoutFailed: 'Failed to clear OAuth tokens',
    cancel: 'Cancel',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from Zeus. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Zeus...',
    placeholderReconnecting: 'Reconnecting to Zeus…',
    ...
    attachUrlDesc: 'Zeus will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Zeus…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Zeus…',
    ...
    unsupportedMessage: 'This version of Zeus can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Zeus from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Zeus will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Zeus desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Zeus updater takes over in its own window and reopens Zeus automatically when it’s done. Please don’t reopen Zeus yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Zeus reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Zeus reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Zeus needs a one-time install',
    ...
    settingUpTitle: 'Setting up Zeus Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Zeus CLI or desktop instance is running. Stop any running Zeus instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Zeus installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Zeus Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Zeus is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Zeus…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Zeus',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Zeus at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Zeus connects automatically',
      loopback: 'Opens your browser to sign in — Zeus connects automatically',
    ...
    authorizeThere: 'Authorize Zeus there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Zeus there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Zeus Desktop v${version}`,
      ...
      gatewayTitle: 'Zeus inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Zeus will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Zeus is restarting...',
      askRestart: 'Ask Zeus to restart the server',
      lookingRestart: taskId => `Zeus is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Zeus is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Zeus finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Zeus could not restart the server.',
      stillWorking:
        'Zeus is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Zeus is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Zeus gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.Zeus/config.yaml). Zeus won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Zeus needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Zeus needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Zeus Desktop to use Save Image.',
    restartToSaveImages: 'Restart Zeus Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `Zeus gateway` running?'
    }
  },
