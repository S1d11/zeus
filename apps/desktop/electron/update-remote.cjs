 ...
 *
 * A public install can end up with `origin=git@github.com:S1d11/zeus.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/S1d11/zeus.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/s1d11/hermes'
