...
description: Modify, debug, or extend the s6-overlay supervision tree inside the Zeus Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
version: 1.0.0
author: Zeus
license: MIT
platforms: [linux]
