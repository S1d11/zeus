...
Browser-based dashboard for managing Zeus configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Zeus” — mixed case, no Mondwest, no `text-display` |
