...
Browser-based dashboard for managing Hermes configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Hermes” — mixed case, no Mondwest, no `text-display` |
