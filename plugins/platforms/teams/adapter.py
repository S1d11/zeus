"""
Microsoft Teams platform adapter for Zeus.
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Zeus"}),
            )
    ...
    async def _fetch_attachment_bytes(self, url: str, timeout: float = 30.0) -> bytes:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                url,
                headers={"User-Agent": "Mozilla/5.0 (compatible; ZeusAgent/1.0)"},
            )
            response.raise_for_status()
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Zeus\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
