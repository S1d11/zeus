...
not replace Zeus's planner, tools, memory, model provider routing, or
...
With this plugin enabled, Zeus can:
...
export HERMES_NEMO_RELAY_ATIF_AGENT_NAME='Zeus E2E'
...
```json
{
  ...
  "session_id": "docs-parent-session",
  "agent": {"name": "Zeus E2E", "version": "docs-example", "model_name": "qwen3.6:35b"},
  "steps": [
    {
      "source": "agent",
