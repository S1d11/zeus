...
not replace Hermes's planner, tools, memory, model provider routing, or
...
With this plugin enabled, Hermes can:
...
export HERMES_NEMO_RELAY_ATIF_AGENT_NAME='Hermes E2E'
...
```json
{
  ...
  "session_id": "docs-parent-session",
  "agent": {"name": "Hermes E2E", "version": "docs-example", "model_name": "qwen3.6:35b"},
  "steps": [
    {
      "source": "agent",
