...
MoA-enabled; the normal Hermes loop still owns tool calling and turn
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Hermes. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Hermes loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
