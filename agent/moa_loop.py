...
MoA-enabled; the normal Zeus loop still owns tool calling and turn
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Zeus. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Zeus loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
