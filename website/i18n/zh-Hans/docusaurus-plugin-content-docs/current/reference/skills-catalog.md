...
sidebar_position: 5
title: "内置技能目录"
description: "随 Hermes 附带的内置技能目录"
---
...
| [`hermes-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) | 配置、扩展或贡献 Hermes。 | `autonomous-ai-agents/hermes-agent` |
