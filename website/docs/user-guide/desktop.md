...
- **Uninstall Chat GUI only** — removes the desktop app and its data; the Zeus, your config, and your chats stay. (Same as `hermes uninstall --gui`.)
