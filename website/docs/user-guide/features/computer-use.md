...
Zeus can drive your desktop — clicking, typing, scrolling,
...
- **Windows: elevated (admin) windows can't be driven from a normal
  ...
  Zeus) cannot enumerate the UIA tree of, or inject mouse input
  ...
  run the Zeus itself at High integrity (launch from an
