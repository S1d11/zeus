...
Hermes can drive your desktop — clicking, typing, scrolling,
...
- **Windows: elevated (admin) windows can't be driven from a normal
  ...
  Hermes) cannot enumerate the UIA tree of, or inject mouse input
  ...
  run the Hermes itself at High integrity (launch from an
