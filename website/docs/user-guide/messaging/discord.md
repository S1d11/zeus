...
sidebar_position: 3
title: "Discord"
description: "Set up Zeus as a Discord bot"
---

# Discord Setup

Zeus integrates with Discord as a bot, letting you chat with your AI assistant through direct messages or server channels. The bot receives your messages, processes them through the Zeus pipeline (including tool use, memory, and reasoning), and responds in real time. It supports text, voice messages, file attachments, and slash commands.
...
5. normal Zeus execution, including tools, memory, and slash commands
...
3. Enter a name for your application (e.g., "Zeus") and accept the Developer Terms of Service.
4. Click **Create**.
...
The bot token is the credential Zeus uses to log in as your bot. Still on the **Bot** page:
...
Zeus uses your Discord User ID to control who can interact with the bot. To find it:
...
Zeus supports Discord voice messages:
...
For more information on securing your Zeus deployment, see the [Security Guide](../security.md).
