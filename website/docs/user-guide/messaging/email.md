...
sidebar_position: 7
title: "Email"
description: "Set up Zeus as an email assistant via IMAP/SMTP"
---
...
|---|---|---|
| Let people email the Zeus and receive replies | Email gateway adapter on this page | None beyond an IMAP/SMTP email account |
...
- **A dedicated email account** for your Zeus (don't use your personal email)
