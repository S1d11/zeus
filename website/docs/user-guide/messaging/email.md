...
sidebar_position: 7
title: "Email"
description: "Set up Hermes as an email assistant via IMAP/SMTP"
---
...
|---|---|---|
| Let people email the Hermes and receive replies | Email gateway adapter on this page | None beyond an IMAP/SMTP email account |
...
- **A dedicated email account** for your Hermes (don't use your personal email)
