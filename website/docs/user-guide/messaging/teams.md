...
description: "Set up Hermes as a Microsoft Teams bot"
---

# Microsoft Teams Setup

Connect Hermes to Microsoft Teams as a bot. Unlike Slack's Socket Mode, Teams delivers messages by calling a **public HTTPS webhook**, so your instance needs a publicly reachable endpoint — either a dev tunnel (local dev) or a real domain (production).
