...
When prompted to connect your account to Hermes, click **Connect**. You'll see a confirmation once it's linked.
...
- **[Run Hermes with Nous Portal](/guides/run-hermes-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
