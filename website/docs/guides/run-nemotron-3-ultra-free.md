...
When prompted to connect your account to Zeus, click **Connect**. You'll see a confirmation once it's linked.
...
- **[Run Zeus with Nous Portal](/guides/run-hermes-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
